//window.onerror = function (desc,page,line,chr){ alert("DESC: "+desc+" Page: "+page+" Line: "+line+ " CHR: "+chr); }
        ...
        var bar;
            ...
            function onDeviceReady() {
                ...
                $.getJSON('http://192.168.0.180/datos.json',
                	...
                	function(data){
                        ...
                        for (var i = 0; i < bares.length; i++) {
							...
							{
                          	if (currentBar.foto) {
                          		 htmlOutput += "<img src='https://upload.wikimedia.org/wikipedia/el/8/8a/Rotary_int_logo.png'/>";
                          	} 
                          		
                          	htmlOutput += "</span><span class='titlespan'>"+currentBar.nombre.content+"</span></a></li>";
							} else {
								if (currentBar.tipo==="Rotaract")
										{
										if (currentBar.foto) {
											htmlOutput += "<img src='http://www.rotarydistrict3000.org/resources/downloads/images/rotaract-logo.png'>";
										} 
                          		
											htmlOutput += "</span><span class='titlespan'>"+currentBar.nombre.content+"</span></a></li>";
										} else {
											if (currentBar.tipo==="Interact"){
													if (currentBar.foto) {
														htmlOutput += "<img src='https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Interact_Logo.jpeg/800px-Interact_Logo.jpeg'/>";
													} 	
											htmlOutput += "</span><span class='titlespan'>"+currentBar.nombre.content+"</span></a></li>";
                ...
                $("#bares").on("click","li",
                	function(){
                        ...
                        //	botonesString += "<a class='button icon-phone' href='tel:+449"+bar.telefono.content.split(" ").join("")+"'>Llamar</a>";
						botonesString += "<a class='button icon-phone' href='tel:+524491822240'>Llamar</a>";
                        } 
